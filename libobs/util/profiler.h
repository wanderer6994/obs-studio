 ...
 * 
 * A named root is used to differentiate between profiling sessions. For 
 * example, a thread may use it to detach itself from the main program root,
 * since it doesn't affect it. The root scope must be opened via #profile_start
 * and closed via #profile_end.
 * 

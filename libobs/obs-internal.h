...
struct obs_textures {
	...
	bool                            textures_customized[NUM_TEXTURES];
...
struct obs_source {
	...
	uint64_t                        audio_ts;
	struct circlebuf                audio_main_input_buf[MAX_AUDIO_CHANNELS];
	struct circlebuf                audio_streaming_input_buf[MAX_AUDIO_CHANNELS];
	struct circlebuf                audio_recording_input_buf[MAX_AUDIO_CHANNELS];
	size_t                          last_audio_main_input_buf_size;
	size_t                          last_audio_streaming_input_buf_size;
	size_t                          last_audio_recording_input_buf_size;
	DARRAY(struct audio_action)     audio_actions;
	float                           *audio_main_output_buf[MAX_AUDIO_MIXES][MAX_AUDIO_CHANNELS];
	float                           *audio_streaming_output_buf[MAX_AUDIO_MIXES][MAX_AUDIO_CHANNELS];
	float                           *audio_recording_output_buf[MAX_AUDIO_MIXES][MAX_AUDIO_CHANNELS];
